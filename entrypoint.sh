...
/etc/init.d/elasticsearch_myCluster start && sleep 3 # port=9201 
/etc/init.d/elasticsearch_myCluster start && sleep 3 # port=9202
/etc/init.d/elasticsearch_myCluster start && sleep 3 # port=9203
