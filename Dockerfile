...
RUN sh /start-new-elasticsearch-cluster.sh $ELASTIC_CLUSTER 9201 && \
    sh /start-new-elasticsearch-cluster.sh $ELASTIC_CLUSTER 9202 && \
    sh /start-new-elasticsearch-cluster.sh $ELASTIC_CLUSTER 9203 && \
    sh /start-new-elasticsearch-cluster.sh $ELASTIC_CLUSTER 9204 && \
    sh /start-new-elasticsearch-cluster.sh $ELASTIC_CLUSTER 9205
##========================================
